...
public enum Message {
    ...
    INDEX_INPUT_ERROR_MESSAGE("Seems you input wrong cell. Input indexes from 0 to %s"),
    STRING_INPUT_ERROR_MESSAGE("Seems you input string. Input numbers in format 12!"),
